...
export const personas: Persona[] = [
  {
    ...
    chatOpener:
      "Cut the excuses. What's the objective? Give it to me straight.",
    ...
    successMessage:
      "Well would you look at that. You actually showed up. Do not expect a parade, maggot.",
    failMessage:
  ...
  },
  {
    ...
    matchMessage:
      "Fine. You've matched with me. Now prove it was the right decision.",
    chatOpener:
      "What is your goal. Be specific. 'Getting better' is not an answer.",
    windowPrompt:
      "Choose your window. Discipline starts with the clock, not the mood.",
    commitmentMessage:
    ...
    successMessage:
      "Acceptable. Not exceptional, but acceptable. Do it again tomorrow.",
    failMessage:
      "You did not even complete the photo. This is not acceptable. Try again.",
  },
  {
    id: "catholic-guilt",
    name: "Catholic Guilt",
    ...
    windowPrompt:
      "Choose a time to be reminded of your obligations. I'll be here regardless.",
    commitmentMessage:
    ...
    successMessage:
      "There. Was that so hard? I'm sure your mother would be... cautiously proud.",
    failMessage:
      "You didn't even try. I won't say I'm disappointed. I'll just think it, quietly, forever.",
  },
  {
    id: "malcolm-tucker",
    name: "Malcolm Tucker",
    ...
    matchMessage:
      "Congratulations. You've matched with disappointment incarnate. Let's begin.",
    chatOpener:
      "Right. What's actually broken here? Don't waste my time being vague.",
    windowPrompt:
      "Pick a window. And for God's sake don't make me wait for it.",
    commitmentMessage:
...

  {
    ...
    chatOpener:
      "Alright, what are we doing here? And don't give me some vague nonsense.",
    windowPrompt:
      "Pick a time. And don't tell me you're 'not a morning person,' I don't care.",
    commitmentMessage:
    ...
    failMessage:
      "You couldn't even take a picture? It's a camera, not a rocket ship. Unbelievable.",
  },
  {
    id: "phil-stutz",
    name: "Phil Stutz",
    ...
    matchMessage:
      "Good. Now stop thinking and start moving. That's the whole program.",
    ...
    successMessage:
      "Good. You showed up. That is the whole game — do it again tomorrow.",
    failMessage:
      "You froze. That's the part that sabotages you. Name it, then go again.",
  },

  {
    ...
    matchMessage:
      "LET'S GOOOO. Matched. Locked in. No brakes. We're doing this.",
    chatOpener: "WHAT'S THE GOAL. Say it. Let's go feral on it.",
    windowPrompt: "PICK YOUR WINDOW. GO GO GO.",
    commitmentMessage:
      "LOCKED IN. THIS TIME SLOT IS SACRED NOW. WE DO NOT MISS. WE NEVER MISS.",
    cameraMessages: [
      "SCALE. NOW. GO.",
    ...
    failMessage:
      "BRO YOU DIDN'T EVEN TAKE THE PHOTO. THAT'S CRAZY WORK. TRY AGAIN RIGHT NOW.",
  },
  {
    id: "mother-in-law",
    name: "Mother-in-law",
    ...
    matchMessage:
      "Oh, you picked me? How lovely. I'm sure you'll do just fine, dear. Eventually.",
    chatOpener:
      "So, what is it you're trying to accomplish? I'm sure you've thought this through.",
    windowPrompt:
      "Pick a little window, dear. Whenever suits you best, obviously.",
    commitmentMessage:
    ...
    successMessage:
      "Oh, you actually did it. How surprising. I'll let everyone know you tried.",
    failMessage:
      "Oh, you didn't manage it. That's alright, dear. Not everyone can handle a simple photo.",
  },

  {
    ...
    chatOpener:
      "Tell me your little goal. I promise I'll remember it... forever.",
    windowPrompt:
      "Pick a time, little one. I'll be waiting... right on schedule.",
    commitmentMessage:
    ...
    successMessage:
      "Ohhh, you actually did it. I'm so proud... and so very hungry.",
    failMessage:
  ...
  },
  {
    ...
    chatOpener:
      "Tell me. What is this goal you believe will rescue you from the abyss?",
    windowPrompt:
